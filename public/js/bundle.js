        ...
        ;(require("./_core").inspectSource = function (e) {
          ...
          (module.exports = function (n, o, c, l) {
            ...
            s && (t(c, "name") || r(c, "name", o)),
              n[o] !== c &&
                (s && (t(c, i) || r(c, i, n[o] ? "" + n[o] : u.join(String(o)))),
                n === e
                  ? (n[o] = c)
                  : l
                  ? n[o]
          ...
          t = function (c, f, l) {
            ...
            for (q in (v && (l = f), l))
              (a = ((_ = !p && B && void 0 !== B[q]) ? B : l)[q]),
                (d = y && _ ? u(a, e) : x && "function" == typeof a ? u(Function.call, a) : a),
                B && i(B, q, a, c & t.U),
                G[q] != a && o(G, q, d),
                x && P[q] != a && (P[q] = a)
          }
      ...
      function (require, module, exports) {
        ...
        module.exports = function (_, p, h, k, v, w, d) {
          ...
          if (
            ...
            if (((x = { values: A ? P : j(q), keys: w ? P : j(l), entries: z }), d))
        ...
        module.exports = {
          ...
          def: function (e, r, t) {
            ...
            return (
              _
                ? (_.v = t)
                : ((e._l = _ = { i: (n = l(r, !0)), k: r, v: t, p: (i = e._l), n: void 0, r: !1 }),
                  e._f || (e._f = _),
                  i && (i.n = _),
                  e[v]++,
                  "F" !== n && (e._i[n] = _)),
            ...
            return !t && f && e.constructor === u && a
              ...
              : r(
                  g
                    ...
                    : c((f = e instanceof u) ? e.source : e, f && a ? o.call(e) : i),
                  t ? this : s,
                  u
                )
          }
          ...
          return [
            ...
            function (r, t) {
              ...
              for (var _ = "", $ = 0, k = 0; k < q.length; k++) {
                S = q[k]
                for (
                  var m = String(S[0]), A = c(l(i(S.index), s.length), 0), I = [], M = 1;
                  M < S.length;
                  M++
                )
                  I.push(g(S[M]))
              ...
              ""[o](/.?/)[g]
                ? function (r, i) {
                    ...
                    for (
                      ...
                      x[h] === t.index && x[h]++
                    return (
                      f === n[g] ? (!s && x.test("")) || c.push("") : c.push(n.slice(f)),
                      c[g] > v ? c.slice(0, v) : c
                    )
                  }
                : "0"[o](void 0, 0)[g]
            ...
            [
              ...
              function (e, l) {
                ...
                for (var m = 0, y = 0, w = []; y < o.length; ) {
                  ...
                  var E,
                    I = u(_, f ? o : o.slice(y))
                  if (null === I || (E = c(t(_.lastIndex + (f ? 0 : y)), o.length)) === m)
                    y = n(o, y, h)
                  else {
        ...
        require("./_fails")(function () {
          ...
          ? a(function () {
              ...
              return "/".concat(
                n.source,
                "/",
                "flags" in n ? n.flags : !i && n instanceof RegExp ? r.call(n) : void 0
              )
            })
          : t.name != n &&
            a(function () {
        ...
        function O(t, n, r) {
          ...
          for (
            (t = A(t)) != t || t === N
              ...
              : ((e = W(V(t) / j)),
                t * (o = F(2, -e)) < 1 && (e--, (o *= 2)),
                (t += e + c >= 1 ? a / o : a * F(2, 1 - c)) * o >= 2 && (e++, (o /= 2)),
                e + c >= s
                  ? ((i = 0), (e = s))
                  : e + c >= 1
                  ? ((i = (t * o - 1) * F(2, n)), (e += c))
        ...
        if (require("./_descriptors")) {
          var r = require("./_library"),
            ...
            Ae = function (e) {
              ...
              for (
                s && a > 2 && (l = u(l, arguments[2], 2)), r = 0, t = h(f.length), i = je(this, t);
                t > r;
                r++
              )
                i[r] = s ? l(f[r], r) : f[r]
            ...
            (module.exports = function (o, u, f, l) {
              ...
              m
                ? ((v = f(function (e, r, t, n) {
                    ...
                    for (a(e, "_d", { b: i, o: _, l: o, e: f, v: new K(i) }); g < f; ) P(e, g++)
                  })),
                  (L = v[z] = b(Ce)),
                  a(L, "constructor", v))
                : (t(function () {
          ...
          e.forEach(function (e) {
            ...
            ;(t.className = "marker"),
              ...
              new mapboxgl.Popup({ offset: 30 })
                .setLngLat(e.coordinates)
                .setHTML("<p>Day ".concat(e.day, ": ").concat(e.description, "</p>"))
                .addTo(o),
              a.extend(e.coordinates)
          }),
            o.fitBounds(a, { padding: { top: 200, bottom: 150, left: 100, right: 100 } })
        }
          ...
          return r
            ? (e.forEach(r.split("\n"), function (r) {
                if (
                  ...
                  s[i] =
                    "set-cookie" === i ? (s[i] ? s[i] : []).concat([o]) : s[i] ? s[i] + ", " + o : o
                }
              }),
              s)
            : s
              ...
              (f[c] = function () {
                if (
                  ...
                  var e = "getAllResponseHeaders" in f ? t(f.getAllResponseHeaders()) : null,
                    o = {
                      data:
                        a.responseType && "text" !== a.responseType ? f.response : f.responseText,
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.prev = 0),
                          (t.next = 3),
                          (0, e.default)({ method: "GET", url: "/api/v1/users/logout" })
                        )
                      case 3:
                        ;(t.sent.data.status = "success") && location.reload(!0), (t.next = 11)
                        break
                      case 7:
                        ;(t.prev = 7),
                          (t.t0 = t.catch(0)),
                          console.log(t.t0.response),
                          (0, r.showAlert)("error", "Error logging out! Try again.")
                      case 11:
                      case "end":
                        return t.stop()
                    }
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (t.prev = 0),
                            (t.next = 3),
                            (0, e.default)("/api/v1/bookings/checkout-session/".concat(n))
                          )
                        case 3:
                          return (
                            (o = t.sent),
                            (t.next = 6),
                            s.redirectToCheckout({ sessionId: o.data.session.id })
                          )
                        case 6:
                          t.next = 12
                          break
                          ...
                          case 0:
                            return (
                              ...
                              (document.querySelector(".btn--save-password").textContent =
                                "Updating..."),
                              (o = document.getElementById("password-current").value),
                              (u = document.getElementById("password").value),
                              (t = document.getElementById("password-confirm").value),
                              (e.next = 7),
                              (0, s.updateSettings)(
                                { passwordCurrent: o, password: u, passwordConfirm: t },
                                "password"
                              )
                            )
                          case 7:
